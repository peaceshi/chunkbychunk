...
public final class ServerEventHandler {
    ...
    public static void onServerStarting(MinecraftServer server) {
        ...
        if (!(overworldStem.generator() instanceof SkyChunkGenerator)) {
            ...
            LevelStem newOverworldStem = new LevelStem(dimensionTypeRegistry.getOrCreateHolder(DimensionType.OVERWORLD_LOCATION), new SkyChunkGenerator(overworldStem.generator(), ChunkByChunkSettings.sealWorld()));
